...
class Example(QWidget):
    ...
    def addRadioBoton(self):
        ...
        gbx = QGroupBox('Elige Un Pais', self)
        gbx.setGeometry(20, 150, 185, 120)
        # crear tres QRadioButton
        radio1 = QRadioButton("Mexico")
        radio2 = QRadioButton("Monterrey")
        radio3 = QRadioButton("Saltillo")
    ...
    def timeSelected(self, date):
        print('Cual Es La Fecha Actual: ', date.toString())
    ...
    def addLineEdit(self):
        ...
        lbl = QLabel('Ingrese Su Nombre:', self)
        lbl.move(20, 52)
        ...
        txt.setPlaceholderText('Nombre De Usuario')
